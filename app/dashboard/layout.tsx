...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Sidebar */}
      <aside className={cn(
        'fixed inset-y-0 left-0 z-50 w-64 bg-card border-r border-border transform transition-transform duration-200 ease-out lg:translate-x-0',
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-5 h-16 border-b border-border">
            <Link href="/dashboard" className="flex items-center gap-2.5">
              ...
              />
              <span className="font-semibold text-lg text-foreground">OPCalls</span>
            </Link>
            <button
              onClick={() => setSidebarOpen(false)}
          ...
          <div className="px-4 py-3 border-b border-border">
            <button className="w-full flex items-center gap-3 p-2.5 rounded-xl bg-secondary hover:bg-secondary/80 transition-colors">
          ...
          <div className="px-4 py-3 border-t border-border">
            <button
              ...
              className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors"
            >
          ...
          <div className="p-3 border-t border-border">
            <div className="flex items-center gap-3 p-2.5 rounded-xl bg-secondary">
      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-30 flex items-center justify-between h-16 px-4 lg:px-6 bg-background/80 backdrop-blur-xl border-b border-border">
          <div className="flex items-center gap-4">
            ...
            {/* Search */}
            <div className="hidden sm:flex items-center gap-2.5 px-4 py-2 bg-secondary rounded-lg border border-border w-64 lg:w-80">
              ...
              />
              <kbd className="hidden lg:inline-flex items-center px-1.5 py-0.5 rounded bg-muted text-[10px] text-muted-foreground border border-border font-mono">
                /
              </kbd>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/dashboard/agents/new">
              <button className="hidden sm:flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground font-medium text-sm rounded-lg hover:bg-primary/90 transition-colors">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            {/* Notifications */}
            <button className="relative p-2 rounded-lg bg-secondary text-muted-foreground hover:text-foreground hover:bg-secondary/80 transition-colors">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
